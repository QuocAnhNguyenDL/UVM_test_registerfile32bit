...
class regfile_scoreboard extends uvm_scoreboard;
    ...
    function void build_phase(uvm_phase phase);
        ...
        rm2sb_fifo = new("act_trans_fifo");
        mon2sb_fifo = new("exp_trans_fifo");
    endfunction
    ...
    task compare();
        ...
        if(act_trans_fifo.size != 0) begin
            ...
            if(exp_trans_fifo.size != 0) begin
                ...
                act_tran.print();
                exp_tran.print();
                 `uvm_info("SCOREBOARD",$sformatf("%d, %d, %d ,%d",act_tran.ReadData1,exp_tran.ReadData1,exp_tran.ReadData2,act_tran.ReadData2), UVM_LOW)

                if(act_tran.ReadData1 == exp_tran.ReadData1 & act_tran.ReadData2 == exp_tran.ReadData2)
                begin
